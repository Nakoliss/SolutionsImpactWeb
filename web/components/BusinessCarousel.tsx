...
import { getDesignConfig } from '@/lib/businessDesigns';
...
function BusinessCarouselContent({
  ...
  const designMessages = businessMessages[
    designConfig.i18nKey as keyof typeof businessMessages
  ...
  const servicesMessages =
    locale === 'fr' ? frMessages.services : enMessages.services;
  const serviceSubtitleLines = servicesMessages.subtitle
    .split('\n')
    .filter(Boolean);
  const contactMessages =
    locale === 'fr' ? frMessages.contact : enMessages.contact;
    ...
    locale === 'fr'
      ? [
          ...
          },
          {
            ...
            description: 'Automatiser ce qui compte, avec des règles claires.',
          },
          {
            icon: '\u{1F4C8}',
      ...
      ? [
          {
            ...
            title: 'Support dédié',
            description:
              'Une expertise réactive qui livre à temps, chaque fois.',
          },
          {
            icon: '\u{1F916}',
            title: 'IA responsable',
      ...
      ? [
          {
            ...
            description:
              'Analyse complète de vos besoins, objectifs et contraintes.',
          },
          {
            title: 'Stratégie & Planification',
            description:
              'Architecture, plan de projet et critères de succès détaillés.',
          },
          {
            title: 'Développement & Tests',
            description:
              'Nous avançons par étapes et validons chaque livrable avec vous.',
          },
          {
            title: 'Déploiement & Lancement',
            description:
              'Mise en production sécurisée accompagnée d’un support actif.',
          },
          {
            title: 'Optimisation & Croissance',
            description:
              'Améliorations continues guidées par vos données et retours.',
          },
        ]
      : [
          {
            ...
            description:
              'Complete review of your needs, goals, and constraints.',
          },
          {
            title: 'Strategy & Planning',
            description:
              'Architecture, project plan, and detailed success criteria.',
          },
          {
            title: 'Development & Testing',
            description:
              'Sprint delivery backed by validation and quality checks.',
          },
          {
            title: 'Deployment & Launch',
            description:
              'Secure go-live with guided rollout and active support.',
          },
          {
  ...
  const displayedSteps =
    locale === 'fr'
      ? [
          {
            title: 'Découverte & évaluation',
            description: 'On cerne vos besoins et contraintes.',
          },
          {
            title: 'Stratégie & planification',
            description: 'Un plan clair et des critères de succès partagés.',
          },
          {
            title: 'Réalisation',
            description:
              'Nous construisons par petites étapes et vérifions avec vous que tout fonctionne.',
          },
          {
            title: 'Déploiement & lancement',
            description: 'Mise en production encadrée et sécurisée.',
          },
          {
            title: 'Optimisation & croissance',
            description: 'Améliorations continues guidées par vos données.',
          },
        ]
      : processSteps;
  ...
  return (
    <div className="bg-slate-950 text-slate-100">
      ...
      <section
        id="hero"
        className="relative overflow-hidden border-b border-white/10 scroll-mt-16"
      >
      ...
      <section
        id="services"
        className="border-b border-white/10 bg-slate-950 scroll-mt-16"
      >
                  ...
                  ? [
                      {
                        title: 'Agilité',
                        description:
                          'Nous avançons par petites étapes, avec des retours fréquents, pour nous adapter vite.',
                      },
                      {
                        title: 'Transparence',
                        description:
                          'Vous savez toujours où en est le projet : échanges clairs, points réguliers et accès au suivi.',
                      },
                      {
                        title: 'Qualité',
                        description:
                          'Des livrables fiables : contrôles qualité soignés et respect de standards reconnus.',
                      },
                      {
                        title: 'Collaboration',
                        description:
                          'Nous travaillons main dans la main avec vos équipes et parties prenantes.',
                      },
                    ]
                  : [
                      {
                        title: 'Agility',
                        description:
                          'Short sprints, regular feedback, and continuous adaptation to changing needs.',
                      },
                      {
                        title: 'Transparency',
                        description:
                          'Open communication, regular reporting, and shared tracking tools.',
                      },
                      {
                        title: 'Quality',
                        description:
                          'Rigorous testing, code reviews, and adherence to industry standards.',
                      },
                      {
                        title: 'Collaboration',
                        description:
                          'Integrated teamwork with your internal stakeholders.',
                      },
                    ]
                ).map((principle) => (
                  <div
      ...
      <section
        id="why"
        className="relative border-t border-white/10 bg-gradient-to-br from-slate-950 via-slate-900/60 to-slate-950 scroll-mt-16 overflow-hidden"
      >
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
              <h2
                id="process"
                className="text-3xl font-semibold sm:text-4xl scroll-mt-16 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent"
              >
                {locale === 'fr' ? 'Notre approche' : 'Our delivery approach'}
              </h2>
              <p className="mt-4 text-base text-slate-300">
                {locale === 'fr'
                  ? 'Un parcours en cinq phases pour passer de la vision à la croissance.'
                  : 'Five phases to move from vision to measurable impact.'}
              </p>
      ...
      <section
        id="assessment"
        className="border-t border-white/10 bg-gradient-to-br from-sky-950 via-slate-950 to-slate-950 scroll-mt-16"
      >
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8 lg:py-20">
          ...
          <ul className="mt-6 flex flex-wrap justify-center gap-3 text-sm text-slate-200">
            {(locale === 'fr'
              ? ['IA responsable', 'Impact mesurable', 'Support dédié']
              : [
