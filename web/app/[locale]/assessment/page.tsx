...
export default async function AssessmentPage({ params }: AssessmentPageProps) {
  ...
  const content = {
    fr: {
      ...
      subtitle:
        "Découvrez où en est votre organisation dans son parcours d'adoption de l'intelligence artificielle",
      description:
        'Notre évaluation gratuite analysera votre niveau de préparation actuel et vous fournira des recommandations personnalisées pour accélérer votre transformation numérique.',
      benefits: [
        ...
        steps: [
          {
            ...
            description:
              'Évaluation rapide de 5-10 minutes couvrant stratégie, technique, données et culture',
          },
          {
            title: 'Obtenez vos résultats',
            description:
              'Score détaillé par catégorie avec niveau de maturité IA global',
          },
          {
            title: 'Recevez vos recommandations',
            description:
              "Plan d'action personnalisé avec prochaines étapes prioritaires",
          },
        ],
      },
    },
    en: {
      ...
      subtitle:
        'Discover where your organization stands in its artificial intelligence adoption journey',
      description:
        'Our free assessment will analyze your current readiness level and provide personalized recommendations to accelerate your digital transformation.',
      benefits: [
        ...
        steps: [
          {
            ...
            description:
              'Quick 5-10 minute assessment covering strategy, technical, data, and culture',
          },
          {
            title: 'Get your results',
            description:
              'Detailed score by category with overall AI maturity level',
          },
          {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AIReadinessAssessmentComplete locale={locale} />
        </div>
      </div>
    </div>
  );
